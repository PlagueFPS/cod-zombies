...
export default function SubscribeEmail({ subscribeUrl }: ISubscribeEmail) {
	...
	// 							We received a request to subscribe your email address to our newsletter. To confirm this request, please
	// 							click the button below.
	// 						</Text>
	// 						<Text className="mb-[24px] text-[#555555] text-[16px] leading-[24px]">
	// 							If you did not request to subscribe, you can safely ignore this email and you&apos;ll not receive our
	// 							newsletters.
	// 						</Text>
