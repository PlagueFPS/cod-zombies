					...
					<Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[20px]">
						...
						<Section className="mb-[32px]">
							<Text className="mb-[16px] text-[16px] text-gray-600 leading-[24px]">
								...
								<strong className="text-orange-500">Interactive Maps</strong> feature for Call of Duty: Zombies! No more
								getting lost in the chaos, our interactive maps will help guide you through every layer of every map so
								you never question where something is located.
							</Text>
						</Section>
						...
						<Section className="mb-[24px] rounded-[8px] bg-gray-100 p-[24px]">
							...
							<ul className="list-disc pl-[24px]">
								...
								<li className="mb-[8px] text-[16px] text-gray-600">
									<strong>Objective Items</strong> - Know the locations of important objective items like Shattered
									Veil&apos;s Janus Crates and more.
								</li>
								<li className="mb-[8px] text-[16px] text-gray-600">
									<strong>Filters</strong> - Narrow down what you are looking for in our maps with filters for each item
									type.
								</li>
								<li className="mb-[8px] text-[16px] text-gray-600">
								...
								<li className="mb-[8px] text-[16px] text-gray-600">
									<strong>Shareable</strong> - Sharing a link of your map will save your filters so the person receiving
