...
export default function UnsubscribeEmail({ unsubscribeUrl }: IUnsubscribeEmail) {
	...
	// 							We received a request to unsubscribe your email address from our newsletter. To confirm this request,
	// 							please click the button below.
	// 						</Text>
	// 						<Text className="mb-[24px] text-[#555555] text-[16px] leading-[24px]">
	// 							If you did not request to unsubscribe, you can safely ignore this email and you&apos;ll continue to
