...
export default async function SideQuestImage({ params }: PageProps<"/side-quests/[game]/[map]/[slug]">) {
  const { slug } = await params
  const [quest, boldFont, semiBoldFont] = await Promise.all([
    getSideQuestBySlug(slug),
