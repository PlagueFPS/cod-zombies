	...
	markers: [
		...
		},
		{
			...
			locations: [
				...
				{ x: 0.527, y: 0.635, title: "Zipline", description: "Use to Fast Travel to the Docks." },
				{
					x: 0.905,
					y: 0.744,
					title: "Elevator",
		...
		},
		{
			...
			locations: [
				...
				},
				{
					...
					description: "Throw a grenade in the trash can next to the door to drop the document.",
				},
				{
					x: 0.42,
					y: 0.762,
