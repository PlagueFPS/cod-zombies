	...
	layers: [
		{
			id: "liberty-falls",
			title: "Liberty Falls",
			image: "/layers/liberty-falls/liberty-falls-layer.webp",
		},
	],
	markers: [
		{
		...
		},
		{
			...
			locations: [
				...
				},
				{
					...
					title: "Zipline",
					description:
						"Use to travel to from West Main Street to the roof of Savings & Loan, or from the roof down to West Main Street.",
				},
				{
					x: 0.542,
					y: 0.52,
				...
				{ x: 0.523, y: 0.447, title: "Zipline", description: "Use to travel to the Cemetery." },
			],
		},
		{
		...
		},
		{
			...
			locations: [
				{ x: 0.644, y: 0.63, title: "The Scientist and The Moonshiner" },
				...
				{ x: 0.138, y: 0.464, title: "The House Josiah Built" },
				{
					...
					y: 0.494,
					title: "Money Talks",
					description: "You must gain access to the vault for this audio log to appear.",
				},
				{
					x: 0.614,
					y: 0.405,
					title: "Limited Run",
					description: "You must complete the Aetherella side quest for this audio log to appear.",
				},
				{
					x: 0.368,
					y: 0.46,
					title: "One Lit Match",
					description: "You must activate the S.D.G. for this audio log to appear.",
				},
			],
		},
		{
			...
			locations: [
				{
					...
					description: "Obtained from opening one of the vault safes.",
				},
				{
					x: 0.321,
					y: 0.431,
					title: "We Only Take Cash",
					description: "Obtained from completing the Mister Peeks Car side quest.",
				},
				{
					x: 0.652,
					y: 0.487,
					title: "Fine Man",
					description:
						"Obtained from shooting movie boxes off the shelves in the Fast Forward store.",
				},
				{
					x: 0.629,
					y: 0.388,
					title: "Final Issue",
					description:
						"Obtained from interacting with white cardboard boxes in Olly's Comics. The document will drop out of one of these boxes.",
				},
			],
		},
		{
		...
		{
			...perks.juggernog,
			locations: [{ x: 0.579, y: 0.42 }],
		},
		{
			...perks["melee-macchiato"],
			locations: [{ x: 0.235, y: 0.65 }],
		},
		{
			...perks["phd-flopper"],
