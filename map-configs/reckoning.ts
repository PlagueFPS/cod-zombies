	...
	layers: [
		{
			...
			markers: [
				...
				},
				{
					...
					locations: [{ x: 0.419, y: 0.67 }],
				},
				{
					...sharedMarkers["armor-wall-buy"],
					locations: [{ x: 0.694, y: 0.562, title: "Tier II Armor Wall Buy" }],
				},
				{
					...sharedMarkers["audio-log"],
					locations: [{ x: 0.523, y: 0.46, title: "Miracle Worker" }],
				},
				{
				...
				},
				{
					...
					locations: [
						{ x: 0.312, y: 0.5, description: "Teleport to T1 Director's Office." },
				...
				},
				{
					...
					locations: [{ x: 0.686, y: 0.454 }],
				},
				{
					...sharedMarkers["vacuum-seal-device"],
					locations: [{ x: 0.688, y: 0.608 }],
				},
				{
					...perks["quick-revive"],
					locations: [{ x: 0.335, y: 0.6 }],
				},
				{
					...weapons.gs45,
		...
		},
		{
			...
			markers: [
					...
					locations: [
						{
							...
							title: "Whistleblower",
							description:
								"You must be playing as Weaver, and reach Round 13 without entering the T1 Mutant Research Lab, then enter the lab to claim this audio log.",
						},
				...
				},
				{
					...
					locations: [{ x: 0.683, y: 0.6 }],
				},
				{
					...perks["phd-flopper"],
					locations: [{ x: 0.3, y: 0.388 }],
				},
				{
					...weapons["pp-919"],
			...
			markers: [
				...
				},
				{
					...
					locations: [
						...
						{ x: 0.63, y: 0.337, title: "The Things I've Seen Pt. 2" },
						{
							x: 0.751,
							y: 0.405,
					...
					locations: [
						{
							...
							description:
								"Shoot the briefcase one of the Klauses is holding to obtain the document.",
						},
					],
				},
				{
				...
				},
				{
					...
					locations: [
						...
						},
						{
							...
							title: "Aether Launcher",
							description:
								"Top Launcher to T1 Mutant Research Lab; Bottom Launcher to T1 Quantum Computing Core",
						},
					],
				},
				{
		...
		},
		{
			...
			markers: [
				...
				},
				{
					...sharedMarkers.trap,
					locations: [
						{ x: 0.748, y: 0.37, title: "C.A.S.T.E.R. Turret" },
						{ x: 0.62, y: 0.244, title: "C.A.S.T.E.R. Turret" },
					],
				},
				{
					...sharedMarkers["vacuum-seal-device"],
		...
		},
		{
			...
			markers: [
				...
				},
				{
					...sharedMarkers.portal,
					locations: [
						{ x: 0.346, y: 0.49, description: "Travel to T2 Dark Entity Containment" },
			...
			markers: [
				...
				},
				{
					...
					locations: [
						...
						{ x: 0.829, y: 0.5, description: "Travel to T1 Project Janus Reception" },
					],
				},
				{
					...sharedMarkers["audio-log"],
				...
				{
					...sharedMarkers["crafting-table"],
					locations: [{ x: 0.69, y: 0.525 }],
				},
				{
					...sharedMarkers["mystery-box"],
					locations: [{ x: 0.345, y: 0.35 }],
				},
				{
		...
		},
		{
			...
			markers: [
				...
				{
					...sharedMarkers["audio-log"],
					locations: [{ x: 0.243, y: 0.34, title: "The Great Voice From Beyond" }],
				},
			],
		},
	],
