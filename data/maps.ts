 ...
 */
export const getMaps = (): Maps[] => Object.values(mapRegistry)
/**
...
const mapRegistry = {
	nachtDerUntoten: {
		...
		releaseDate: new Date("November 11, 2008 07:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	verruckt: {
		id: "verruckt",
		title: "Verrückt",
		releaseDate: new Date("March 19, 2009 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	shiNoNuma: {
		id: "shi-no-numa",
		title: "Shi No Numa",
		releaseDate: new Date("June 10, 2009 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	derRiese: {
		id: "der-riese",
		title: "Der Riese",
		releaseDate: new Date("August 05, 2009 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	kinoDerToten: {
		...
		releaseDate: new Date("November 09, 2010 07:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	five: {
		id: "five",
		title: '"Five"',
		releaseDate: new Date("November 09, 2010 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	ascension: {
		id: "ascension",
		title: "Ascension",
		releaseDate: new Date("February 01, 2011 07:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	callOfTheDead: {
		...
		releaseDate: new Date("March 17, 2011 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	shangriLa: {
		id: "shangri-la",
		title: "Shangri-La",
		releaseDate: new Date("June 28, 2011 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	moon: {
		id: "moon",
		title: "Moon",
		releaseDate: new Date("August 23, 2011 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	tranzit: {
		id: "tranzit",
		title: "Tranzit",
		releaseDate: new Date("November 12, 2012 07:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
			"Continue the fight against the undead and search for clues to the truth of what lies ahead...",
		image: "/maps/tranzit.avif",
		game: blackOps2,
	},
	dieRise: {
		id: "die-rise",
		title: "Die Rise",
		releaseDate: new Date("January 29, 2013 07:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/die-rise.avif",
		game: blackOps2,
	},
	mobOfTheDead: {
		id: "mob-of-the-dead",
		title: "Mob of the Dead",
		releaseDate: new Date("April 16, 2013 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
			"Battle the undead as you attempt to break free from the physical and metaphorical incarceration of Alcatraz Prison.",
		image: "/maps/mob-of-the-dead.avif",
		game: blackOps2,
	},
	buried: {
		id: "buried",
		title: "Buried",
		releaseDate: new Date("July 02, 2013 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/buried.avif",
		game: blackOps2,
	},
	origins: {
		id: "origins",
		title: "Origins",
		releaseDate: new Date("August 27, 2013 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
			"Witness the origins of Group 935, as an ancient evil is unleashed upon the battlefields of World War I.",
		image: "/maps/origins.avif",
		game: blackOps2,
	},
	shadowsOfEvil: {
		id: "shadows-of-evil",
		title: "Shadows of Evil",
		releaseDate: new Date("November 06, 2015 07:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	theGiant: {
		id: "the-giant",
		title: "The Giant",
		releaseDate: new Date("November 06, 2015 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
			"Re-awaken The Giant. Return to the secret facility where it all began, and strike at the heart of the zombie scourge.",
		image: "/maps/the-giant.avif",
		game: blackOps3,
	},
	derEisendrache: {
		id: "der-eisendrache",
		title: "Der Eisendrache",
		releaseDate: new Date("February 02, 2016 07:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/der-eisendrache.avif",
		game: blackOps3,
	},
	zetsubouNoShima: {
		id: "zetsubou-no-shima",
		title: "Zetsubou No Shima",
		releaseDate: new Date("April 19, 2016 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	gorodKrovi: {
		id: "gorod-krovi",
		title: "Gorod Krovi",
		releaseDate: new Date("June 12, 2016 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	revelations: {
		id: "revelations",
		title: "Revelations",
		releaseDate: new Date("September 06, 2016 08:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	voyageOfDespair: {
		...
		releaseDate: new Date("October 11, 2018 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/voyage-of-despair.avif",
		game: blackOps4,
	},
	ix: {
		id: "ix",
		title: "IX",
		releaseDate: new Date("October 11, 2018 01:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
	...
	bloodOfTheDead: {
		...
		releaseDate: new Date("October 11, 2018 02:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/blood-of-the-dead.avif",
		game: blackOps4,
	},
	classified: {
		id: "classified",
		title: " Classified",
		releaseDate: new Date("October 11, 2018 03:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description: "Mankind must put an end to war – or war will put an end to mankind. (JFK, 1961)",
		image: "/maps/classified.avif",
		game: blackOps4,
	},
	deadOfTheNight: {
		id: "dead-of-the-night",
		title: "Dead of the Night",
		releaseDate: new Date("December 11, 2018 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/dead-of-the-night.avif",
		game: blackOps4,
	},
	ancientEvil: {
		id: "ancient-evil",
		title: "Ancient Evil",
		releaseDate: new Date("March 26, 2019 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/ancient-evil.avif",
		game: blackOps4,
	},
	alphaOmega: {
		id: "alpha-omega",
		title: "Alpha Omega",
		releaseDate: new Date("July 09, 2019 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
			"Here at Broken Arrow, it is our Mission to Prepare for Humanity’s Future and Open New Worlds.",
		image: "/maps/alpha-omega.avif",
		game: blackOps4,
	},
	tagDerToten: {
		id: "tag-der-toten",
		title: "Tag der Toten",
		releaseDate: new Date("September 23, 2019 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description: "The Paradox Must Be Resolved.",
		image: "/maps/tag-der-toten.avif",
		game: blackOps4,
	},
	dieMaschine: {
		id: "die-maschine",
		title: "Die Maschine",
		releaseDate: new Date("November 13, 2020 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/die-maschine.avif",
		game: blackOpsColdWar,
	},
	firebaseZ: {
		id: "firebase-z",
		title: "Firebase Z",
		releaseDate: new Date("February 04, 2021 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/firebase-z.avif",
		game: blackOpsColdWar,
	},
	mauerDerToten: {
		id: "mauer-der-toten",
		title: "Mauer der Toten",
		releaseDate: new Date("July 15, 2021 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/mauer-der-toten.avif",
		game: blackOpsColdWar,
	},
	forsaken: {
		id: "forsaken",
		title: "Forsaken",
		releaseDate: new Date("October 07, 2021 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/forsaken.avif",
		game: blackOpsColdWar,
	},
	libertyFalls: {
		id: "liberty-falls",
		title: "Liberty Falls",
		releaseDate: new Date("October 25, 2024 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/liberty-falls.avif",
		game: blackOps6,
	},
	terminus: {
		id: "terminus",
		title: "Terminus",
		releaseDate: new Date("October 25, 2024 01:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/terminus.avif",
		game: blackOps6,
	},
	citadelleDesMorts: {
		id: "citadelle-des-morts",
		title: "Citadelle des Morts",
		releaseDate: new Date("December 05, 2024 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/citadelle-des-morts.avif",
		game: blackOps6,
	},
	theTomb: {
		id: "the-tomb",
		title: "The Tomb",
		releaseDate: new Date("January 28, 2025 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/the-tomb.avif",
		game: blackOps6,
	},
	shatteredVeil: {
		id: "shattered-veil",
		title: "Shattered Veil",
		releaseDate: new Date("April 02, 2025 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
		...
		image: "/maps/shattered-veil.avif",
		game: blackOps6,
	},
	reckoning: {
		id: "reckoning",
		title: "Reckoning",
		releaseDate: new Date("August 07, 2025 12:00 AM").toLocaleDateString("en-US", DATE_OPTIONS),
		description:
