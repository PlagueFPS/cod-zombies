...
const sideQuestRegistry = {
	...
	rememberUs: {
		id: "remember-us",
		lastUpdated: await getLastUpdated("./content/side-quest/remember-us.mdx"),
		title: "Remember Us",
		description: `Discover the hidden Music Easter Egg Song "Remember Us" by Kevin Sherwood with vocals by Elena Siegman.`,
		map: reckoning,
		content: () => import("@/content/side-quest/remember-us.mdx"),
	},
	samanthasPeace: {
		id: "samanthas-peace",
		lastUpdated: await getLastUpdated("./content/side-quest/samanthas-peace.mdx"),
		title: "Samantha's Peace",
		description: `Discover this hidden Music Easter Egg Song "Samantha's Peace" by Brian Tuey.`,
		map: reckoning,
		content: () => import("@/content/side-quest/samanthas-peace.mdx"),
	},
	chickenBucketHat: {
		id: "chicken-bucket-hat",
		lastUpdated: await getLastUpdated("./content/side-quest/chicken-bucket-hat.mdx"),
		...
		map: reckoning,
		content: () => import("@/content/side-quest/chicken-bucket-hat.mdx"),
	},
	vendingMachineReckoning: {
		id: "vending-machine-reckoning",
		lastUpdated: await getLastUpdated("./content/side-quest/vending-machine-reckoning.mdx"),
		title: "Vending Machine",
		...
		map: reckoning,
		content: () => import("@/content/side-quest/vending-machine-reckoning.mdx"),
	},
	freeSelfReviveReckoning: {
		id: "free-self-revive-reckoning",
		lastUpdated: await getLastUpdated("./content/side-quest/free-self-revive-reckoning.mdx"),
		title: "Free Self Revive",
		description: `Learn how to earn a free Self-Revive with a reference to the Element 115.`,
		map: reckoning,
		content: () => import("@/content/side-quest/free-self-revive-reckoning.mdx"),
	},
	paintings: {
		id: "paintings",
		lastUpdated: await getLastUpdated("./content/side-quest/paintings.mdx"),
		title: "Paintings",
		...
		map: reckoning,
		content: () => import("@/content/side-quest/paintings.mdx"),
	},
	parachutingChallenge: {
		id: "parachuting-challenge",
		lastUpdated: await getLastUpdated("./content/side-quest/parachuting-challenge.mdx"),
		...
		map: reckoning,
		content: () => import("@/content/side-quest/parachuting-challenge.mdx"),
	},
	hardcoreBossfight: {
		id: "hardcore-bossfight",
		lastUpdated: await getLastUpdated("./content/side-quest/hardcore-bossfight.mdx"),
		...
		map: reckoning,
		content: () => import("@/content/side-quest/hardcore-bossfight.mdx"),
	},
	aetherellaCompanion: {
		id: "aetherella-companion",
		lastUpdated: await getLastUpdated("./content/side-quest/aetherella-companion.mdx"),
		...
		map: reckoning,
		content: () => import("@/content/side-quest/aetherella-companion.mdx"),
	},
	pointsChallenge: {
		id: "points-challenge",
		lastUpdated: await getLastUpdated("./content/side-quest/points-challenge.mdx"),
		...
		map: reckoning,
		content: () => import("@/content/side-quest/points-challenge.mdx"),
	},
	targetPractice: {
		id: "target-practice",
		lastUpdated: await getLastUpdated("./content/side-quest/target-practice.mdx"),
		...
		map: reckoning,
		content: () => import("@/content/side-quest/target-practice.mdx"),
	},
	goldenTrashBin: {
		id: "golden-trash-bin",
		lastUpdated: await getLastUpdated("./content/side-quest/golden-trash-bin.mdx"),
		...
		map: reckoning,
		content: () => import("@/content/side-quest/golden-trash-bin.mdx"),
	},
	casterTurretUpgrade: {
		id: "caster-turret-upgrade",
		lastUpdated: await getLastUpdated("./content/side-quest/caster-turret-upgrade.mdx"),
		...
		map: reckoning,
		content: () => import("@/content/side-quest/caster-turret-upgrade.mdx"),
	},
	hiddenPowerUpsReckoning: {
		id: "hidden-power-ups-reckoning",
		lastUpdated: await getLastUpdated("./content/side-quest/hidden-power-ups-reckoning.mdx"),
		title: "Hidden Power Ups",
		description: `Discover every hidden Power-Up location within Reckoning for you to spawn in at any time if you need them.`,
		map: reckoning,
		content: () => import("@/content/side-quest/hidden-power-ups-reckoning.mdx"),
	},
	jumpScareReckoning: {
		id: "jump-scare-reckoning",
		lastUpdated: await getLastUpdated("./content/side-quest/jump-scare-reckoning.mdx"),
		title: "Jump Scare",
		description: `Discover this hidden jumpscare within Reckoning that will remind you of the loss Richtofen has faced.`,
		map: reckoning,
		content: () => import("@/content/side-quest/jump-scare-reckoning.mdx"),
	},
	freeDeadshotDaiquiri: {
		id: "free-deadshot-daiquiri",
		lastUpdated: await getLastUpdated("./content/side-quest/free-deadshot-daiquiri.mdx"),
		...
		map: reckoning,
		content: () => import("@/content/side-quest/free-deadshot-daiquiri.mdx"),
	},
	aetherBlade: {
		id: "aether-blade",
		lastUpdated: await getLastUpdated("./content/side-quest/aether-blade.mdx"),
		title: "Aether Blade",
		description: `Learn how to obtain one of the most powerful lethal equipment in Call of Duty: Zombies in your game.`,
		map: reckoning,
		content: () => import("@/content/side-quest/aether-blade.mdx"),
	},
