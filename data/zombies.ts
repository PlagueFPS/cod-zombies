...
const zombiesRegistry = {
	...
	mimic: {
		...
		games: [getGameByKey("blackOpsColdWar")],
		maps: [getMapByKey("firebaseZ"), getMapByKey("mauerDerToten"), getMapByKey("forsaken")],
		type: "Special",
		speed: "Medium",
		weakPoints: [getWeakPointByKey("mouth")],
		elementalWeakness: [],
		attacks: [getZombieAttackByKey("meleeSwing"), getZombieAttackByKey("tentacleGrab")],
		spawnBehavior:
	...
	shockMimic: {
		...
		combatStrategy: Effect.promise(() => import("@/content/zombies/shock-mimic.mdx")),
	},
	sentinelArtifact: {
