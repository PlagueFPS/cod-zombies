...
const zombiesRegistry = {
	...
	armoredZombie: {
		...
		games: [blackOpsColdWar, blackOps6, blackOps7],
		maps: [
			dieMaschine,
			firebaseZ,
			mauerDerToten,
	...
	doppelghast: {
		...
		games: [blackOps6, blackOps7],
		maps: [citadelleDesMorts, theTomb, shatteredVeil, reckoning, ashesOfTheDamned],
		type: "Special",
		speed: "Fast",
		weakPoints: [head],
	...
	ravager: {
		...
		games: [blackOps7],
		maps: [ashesOfTheDamned],
		type: "Special",
		speed: "Fast",
		weakPoints: [head],
		elementalWeakness: [],
		attacks: [meleeSwing, ravage],
		spawnBehavior: "Ravagers spawn as the special round in Ashes of the Damned, and will spawn in among normal zombies in the later rounds.",
	...
	zursa: {
		...
		type: "Elite",
		speed: "Medium",
		weakPoints: [redGlowingSpots, beeNests],
		elementalWeakness: [napalmBurst],
		attacks: [maul, beeSwarm],
		spawnBehavior: "Zursa will first spawn on Round 16, then every 3-5 rounds after that with the chance for multiple to spawn on those rounds.",
