...
const interactiveMapHashMap = HashMap.make(
	makeMapEntry("paradox-junction", {
		...
		game: "black-ops-7",
		description:
			"Explore Paradox Junction in Black Ops 7 Zombies. Find all locations for all Loot Cysts, Aether Cystals, Perks, Weapons, intel, and more with our interactive map.",
	}),
