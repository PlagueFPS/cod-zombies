...
export const main_quests = sqliteTable(
  ...
  (columns) => ({
    ...
    main_quests_created_at_idx: index("main_quests_created_at_idx").on(
      columns.createdAt,
    ),
    main_quests__status_idx: index("main_quests__status_idx").on(
      columns._status,
    ),
  }),
);
...
export const _main_quests_v = sqliteTable(
  ...
  (columns) => ({
    ...
    _main_quests_v_created_at_idx: index("_main_quests_v_created_at_idx").on(
      columns.createdAt,
    ),
    _main_quests_v_updated_at_idx: index("_main_quests_v_updated_at_idx").on(
      columns.updatedAt,
    ),
...
export const side_quests = sqliteTable(
  ...
  (columns) => ({
    ...
    side_quests_created_at_idx: index("side_quests_created_at_idx").on(
      columns.createdAt,
    ),
    side_quests__status_idx: index("side_quests__status_idx").on(
      columns._status,
    ),
  }),
);
...
export const _side_quests_v = sqliteTable(
  ...
  (columns) => ({
    ...
    _side_quests_v_version_version_image_idx: index(
      "_side_quests_v_version_version_image_idx",
    ...
    _side_quests_v_created_at_idx: index("_side_quests_v_created_at_idx").on(
      columns.createdAt,
    ),
    _side_quests_v_updated_at_idx: index("_side_quests_v_updated_at_idx").on(
      columns.updatedAt,
    ),
...
export const zombies = sqliteTable(
  ...
  (columns) => ({
    ...
    zombies_created_at_idx: index("zombies_created_at_idx").on(
      columns.createdAt,
    ),
...
export const zombies_rels = sqliteTable(
  ...
  (columns) => ({
    ...
    zombies_rels_games_id_idx: index("zombies_rels_games_id_idx").on(
      columns.gamesID,
    ),
    ...
    zombies_rels_zombie_attacks_id_idx: index(
      "zombies_rels_zombie_attacks_id_idx",
...
export const _zombies_v = sqliteTable(
  ...
  (columns) => ({
    ...
    _zombies_v_version_version_image_idx: index(
      "_zombies_v_version_version_image_idx",
    ).on(columns.version_image),
    ...
    _zombies_v_version_version__status_idx: index(
      "_zombies_v_version_version__status_idx",
    ).on(columns.version__status),
    _zombies_v_created_at_idx: index("_zombies_v_created_at_idx").on(
      columns.createdAt,
    ),
    _zombies_v_updated_at_idx: index("_zombies_v_updated_at_idx").on(
      columns.updatedAt,
    ),
...
export const _zombies_v_rels = sqliteTable(
  ...
  (columns) => ({
    ...
    _zombies_v_rels_games_id_idx: index("_zombies_v_rels_games_id_idx").on(
      columns.gamesID,
    ),
    ...
    _zombies_v_rels_zombie_attacks_id_idx: index(
      "_zombies_v_rels_zombie_attacks_id_idx",
    ).on(columns.zombieAttacksID),
    parentFk: foreignKey({
      columns: [columns["parent"]],
...
export const gobblegum = sqliteTable(
  ...
  (columns) => ({
    ...
    gobblegum_created_at_idx: index("gobblegum_created_at_idx").on(
      columns.createdAt,
    ),
  }),
);
...
export const ammo_mods = sqliteTable(
  ...
  (columns) => ({
    ...
    ammo_mods_created_at_idx: index("ammo_mods_created_at_idx").on(
      columns.createdAt,
    ),
  }),
);
...
export const field_upgrades = sqliteTable(
  ...
  (columns) => ({
    ...
    field_upgrades_updated_at_idx: index("field_upgrades_updated_at_idx").on(
      columns.updatedAt,
    ),
    field_upgrades_created_at_idx: index("field_upgrades_created_at_idx").on(
      columns.createdAt,
    ),
  }),
);
...
export const zombie_attacks = sqliteTable(
  ...
  (columns) => ({
    ...
    zombie_attacks_created_at_idx: index("zombie_attacks_created_at_idx").on(
      columns.createdAt,
    ),
  }),
);
...
export const weapons = sqliteTable(
  ...
  (columns) => ({
    ...
    weapons_created_at_idx: index("weapons_created_at_idx").on(
      columns.createdAt,
    ),
  }),
);
...
export const weapon_builds = sqliteTable(
  ...
  (columns) => ({
    ...
    weapon_builds_created_at_idx: index("weapon_builds_created_at_idx").on(
      columns.createdAt,
    ),
  }),
);
...
export const _legal_v = sqliteTable(
  ...
  (columns) => ({
    ...
    _legal_v_version_version_updated_at_idx: index(
      "_legal_v_version_version_updated_at_idx",
    ).on(columns.version_updatedAt),
    _legal_v_version_version_created_at_idx: index(
      "_legal_v_version_version_created_at_idx",
    ).on(columns.version_createdAt),
    _legal_v_version_version__status_idx: index(
      "_legal_v_version_version__status_idx",
    ).on(columns.version__status),
    _legal_v_created_at_idx: index("_legal_v_created_at_idx").on(
      columns.createdAt,
    ),
    _legal_v_updated_at_idx: index("_legal_v_updated_at_idx").on(
      columns.updatedAt,
    ),
...
export const relations__main_quests_v = relations(
  _main_quests_v,
  ({ one }) => ({
...
export const relations__side_quests_v = relations(
  _side_quests_v,
  ({ one }) => ({
...
export const relations_field_upgrades = relations(
  field_upgrades,
  ({ one }) => ({
    game: one(games, {
...
export const relations_weapon_builds = relations(
  weapon_builds,
  ({ one, many }) => ({
    weapon: one(weapons, {
