...
export const decodeRichLinkNode =
  Schema.decodeUnknownEither(RichLinkNodeSchema);
...
export const decodeReckoningCode =
  Schema.decodeUnknownEither(ReckoningCodeSchema);
