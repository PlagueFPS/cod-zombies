...
- [x] create all MDX pages
- [x] refactor existing components to use new metadata for previewing
- [x] refactor existing `page.tsx` files to use new MDX content
- [x] populate all MDX pages with content
