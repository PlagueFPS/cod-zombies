...
export default function SubscribeEmail({ subscribeUrl, serverUrl }: ISubscribeEmail) {
	return (
		<Html>
			<Tailwind>
				<Head>
					...
					<Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[20px]">
						...
						<Section className="border-t border-solid border-[#e6ebf1] pt-[32px]">
							...
							<Text className="mb-[24px] text-[16px] leading-[24px] text-[#555555]">
								We received a request to subscribe your email address to our newsletter. To confirm
								this request, please click the button below.
							</Text>
							<Text className="mb-[24px] text-[16px] leading-[24px] text-[#555555]">
								If you did not request to subscribe, you can safely ignore this email and
								you&apos;ll not receive our newsletters.
							</Text>
							...
							<Text className="mb-[24px] text-[14px] text-[#8898aa] italic">
								...
								into your browser:
								<br />
								<Link href={subscribeUrl} className="break-all underline">
									{subscribeUrl}
								</Link>
							</Text>
							<Text className="mb-[24px] text-[14px] text-[#8898aa] italic">
