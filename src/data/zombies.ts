...
const ZOMBIES = new Map([
	...
	makeZombie("shadow-soul", {
		...
		description:
			"These shadowy figures bind the corruption of the Dark Aether to the Shadowsmith temples and shield the Warden from purification.",
		games: ["black-ops-7"],
		maps: ["rex-infernus"],
		type: "Special",
		speed: "Slow",
		weakPoints: ["head"],
		elementalWeakness: ["light-mend"],
		attacks: ["shadow-shield"],
		spawnBehavior:
			"Shadow Souls spawn during the Main Quest of Rex Infernus, during the temple cleansing rituals and during the boss fight.",
		combatStrategy: "content/zombies/shadow-soul",
	}),
	...
	makeZombie("wardens-stinger", {
		...
		description:
			"These summoned creatures are the Warden's last line of defense, helping him regain control and unleash devastating attacks on foes.",
		games: ["black-ops-7"],
		maps: ["rex-infernus"],
		type: "Special",
		speed: "Slow",
		weakPoints: ["red-glowing-spots"],
		elementalWeakness: ["cryo-freeze"],
		attacks: ["lunge", "poison-projectile"],
		spawnBehavior:
			"Warden's Stingers only spawn during the Rex Infernus boss fight in the later phases.",
		combatStrategy: "content/zombies/wardens-stinger",
	}),
