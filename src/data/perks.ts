...
const PERKS = uniqueMap([
	...
	makePerk("mule-munchies", {
		title: "Mule Munchies",
		description: "Sometimes you need a third hand! (Allows you to wield a third weapon)",
	...
	makePerk("racin-stripes", {
		title: "Racin' Stripes",
		description: "Run so far away! (Increases your stamina and sprint speed)",
	...
	makePerk("tuff-nuff", {
		title: "Tuff 'Nuff",
		description: "Got Health? Have more! (Increased your max health)",
		image: "/perks/tuff-nuff.webp",
		modifier: Option.none(),
		augments: Option.none(),
		variants: Option.none(),
	}),
