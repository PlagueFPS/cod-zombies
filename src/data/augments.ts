...
const AUGMENTS = new Map([
	...
	makeAugment("armor-matic", {
		...
		type: "Major",
		image: "/augments/bo7/armor-matic-major-augment-bo7.webp",
		variants: Option.none(),
	}),
	...
	makeAugment("big-game-shatter-blast", {
		title: "Big Game",
		description: "Shatter Blast can activate on Elite Enemies.",
		type: "Major",
		image: "/augments/bo7/big-game-major-augment-bo7.webp",
		variants: Option.none(),
	}),
	makeAugment("blast-chain", {
		title: "Blast Chain",
		description: "Shatter Blast has additional detonations.",
		type: "Major",
		image: "/augments/bo7/firebomb-major-augment-bo7.webp",
		variants: Option.none(),
	}),
	makeAugment("blast-repair", {
		title: "Blast Repair",
		description: "When Shatter Blast destroys enemy armor, some of your armor is restored.",
		type: "Major",
		image: "/augments/bo7/armor-matic-major-augment-bo7.webp",
		variants: Option.none(),
	}),
	makeAugment("blast-shield", {
		title: "Blast Shield",
		description:
			"Damaging multiple enemies with Shatter Blast temporarily mitigates damage you receive.",
		type: "Major",
		image: "/augments/bo7/equivalent-exchange-major-augment-bo7.webp",
		variants: Option.none(),
	}),
	makeAugment("blast-zone", {
		title: "Blast Zone",
		description: "Increase the size of the explosion.",
		type: "Minor",
		image: "/augments/bo7/blast-zone-minor-augment-bo7.webp",
		variants: Option.none(),
	}),
	makeAugment("blast-boost", {
		title: "Blast Boost",
		description: "Increase the explosion damage.",
		type: "Minor",
		image: "/augments/bo7/contact-burn-minor-augment-bo7.webp",
		variants: Option.none(),
	}),
	makeAugment("blast-wave", {
		title: "Blast Wave",
		description: "Normal Enemies are knocked down by the explosion.",
		type: "Minor",
		image: "/augments/bo7/blast-wave-minor-augment-bo7.webp",
		variants: Option.none(),
	}),
	makeAugment("blast-through", {
		title: "Blast Through",
		description: "Weapons with Shatter Blast deal more damage through armor.",
		type: "Minor",
		image: "/augments/bo7/eod-technician-minor-augment-bo7.webp",
		variants: Option.none(),
	}),
