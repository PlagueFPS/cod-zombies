"use client"
import type { MinifiedFieldUpgrade } from "@/data/field-upgrades"
...
export default function FieldUpgradeTooltipClient({
	...
	fieldUpgrade: MinifiedFieldUpgrade
}) {
...
const FieldUpgradeTooltipContent = ({ fieldUpgrade }: { fieldUpgrade: MinifiedFieldUpgrade }) => {
	return (
